...
struct device_attribute {
	...
	ssize_t (*show)(struct device *dev, struct device_attribute *attr,
			char *buf);
	/*<llj>Ð´ÈëµÄbuffer¼°Æä´óÐ¡£¬ÆäÖÐbufferÒÑ¾­×ª»»µ½ÁËÄÚºË¿Õ¼ä</llj>*/
...
ssize_t device_store_int(struct device *dev, struct device_attribute *attr,
			 const char *buf, size_t count);
/*<llj>Ãû³Æ£¬È¨ÏÞÎ»£¬¶Áº¯Êý£¬Ð´º¯Êý</llj>*/
...
struct device {
	...
	struct device_node	*of_node; /* associated device tree node<llj>¶ÔÓ¦µÄÉè±¸Ê÷½Úµã</llj> */
